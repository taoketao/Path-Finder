...
#        self.valid_states = np.append(self.valid_states, np.expand_dims(\
    ...
    def get_starting_state(self, curriculum_name, epoch): 
        if curriculum_name==None:   return self.get_random_starting_state()['state']
        if curriculum_name=='FLAT': return self.get_random_starting_state()['state']
